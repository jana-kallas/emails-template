    ...
    <Tailwind config={tailwindConfig}>
      <Html>
        <div className="max-w-[600px] mx-auto">
          <Header
            header="https://i.ibb.co/HfXYRbQL/Email-2-EN-1.png"
            altText="Header"
          />
          <div className="px-3 font-public">
            <Welcome />
            <p>
              The deadline to submit your Proof of Address has now passed, and
              we have not received the required documentation. As a result and
              in line with our regulatory obligations, your trading account has
              been restricted until a valid Proof of Address is provided.
            </p>
            <p>
              The restrictions applied may include, but are not limited to
              close-only mode, withdrawal limitations, and potential account
              suspension or closure if the document remains outstanding.
            </p>
            <p>
              To remove these restrictions, you are urgently required to submit
              a valid Prood of Address issued within the last 3 months and under
              your own name.
            </p>
            <div className="mb-8">
              ...
              <p>
                Please send your Proof of Address directly to{" "}
                <a href="mailto:cs@4t.com" className="no-underline text-black">
                  cs@4t.com
                </a>{" "}
                at your earliest convenience. Once received and verified, all
                restrictions will be lifted accordingly.
              </p>
            </div>
            <Divider />
            <ContactBlock
