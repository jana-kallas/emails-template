    ...
    <Tailwind config={tailwindConfig}>
      <Html>
        <div className="max-w-[600px] mx-auto">
          <Header
            header="https://i.ibb.co/RkDwTHDG/Email-2-FR.png"
            altText="Header"
          />
          <div className="px-3 font-public">
            <Welcome />
            <p>
              La date limite pour soumettre votre justificatif de domicile est
              dépassée et nous n'avons pas reçu le document requis. Par
              conséquent, et conformément à nos obligations réglementaires,
              votre compte de trading est bloqué jusqu'à réception d'un
              justificatif de domicile valide.
            </p>
            <p>
              Les restrictions appliquées peuvent inclure, sans s'y limiter, le
              mode de fermeture uniquement, des limitations de retrait et, le
              cas échéant, la suspension ou la fermeture de votre compte si le
              document n'est toujours pas fourni.
            </p>
            <p>
              Pour lever ces restrictions, vous devez nous faire parvenir
              d'urgence un justificatif de domicile valide, datant de moins de 3
              mois et établi à votre nom.
            </p>
            <div className="mb-8">
              <span className="font-bold">Documents acceptés :</span>
              <ul>
              ...
              <p>
                Veuillez envoyer votre justificatif de domicile directement à{" "}
                <a href="mailto:cs@4t.com" className="no-underline text-black">
                  cs@4t.com
                </a>{" "}
                dès que possible. Une fois reçu et vérifié, toutes les
